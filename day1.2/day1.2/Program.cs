...
namespace day1
{
    class Program
    {
        ...
        static void Part1()
        {
            ...
            flag = frequency;
            Console.WriteLine("Day 1 - part one flag is: " + flag);
        }

        static void Part2()
        {
            Dictionary<int, int> previousFrequencies = new Dictionary<int, int>();
            int counter = 0;
            int frequency = 0;
            while (true)
            {
                frequency += frequencies[counter % frequencies.Count];
                if (previousFrequencies.ContainsKey(frequency))
                {
                    flag2 = frequency;
                    Console.WriteLine("Day 1 - part two flag is: " + flag2);
                    return;
                }
                previousFrequencies.Add(frequency, 0);
                counter++;
            }
        }
    }
